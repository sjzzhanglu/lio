    ...
    <div class="container">
      ...
      <div class="demo-row typography-row">
      	...
      	<div class="demo-content">
	          ...
	          <img src="{{ url('/') }}/Flat-UI/docs/assets/images/example-image.jpg" alt="example-image" class="img-rounded img-responsive">
      ...
      <div class="demo-illustrations">
        <div class="demo-content">
          <div><img src="{{ url('/') }}/Flat-UI/docs/assets/images/icons/toilet-paper.svg" alt="Toilet-Paper"></div>
          <div><img src="{{ url('/') }}/Flat-UI/docs/assets/images/icons/gift-box.svg" alt="Gift-Box"></div>
          <div><img src="{{ url('/') }}/Flat-UI/docs/assets/images/icons/pencils.svg" alt="Pensils"></div>
          <div><img src="{{ url('/') }}/Flat-UI/docs/assets/images/icons/clipboard.svg" alt="Clipboard"></div>
          <div><img src="{{ url('/') }}/Flat-UI/docs/assets/images/icons/retina.svg" alt="Retina"></div>
          <div><img src="{{ url('/') }}/Flat-UI/docs/assets/images/icons/compas.svg" alt="Compas"></div>
          <div><img src="{{ url('/') }}/Flat-UI/docs/assets/images/icons/map.svg" alt="Map"></div>
          <div><img src="{{ url('/') }}/Flat-UI/docs/assets/images/icons/chat.svg" alt="Chat"></div>
          <div><img src="{{ url('/') }}/Flat-UI/docs/assets/images/icons/mail.svg" alt="Mail"></div>
          <div><img src="{{ url('/') }}/Flat-UI/docs/assets/images/icons/book.svg" alt="Book"></div>
          <div><img src="{{ url('/') }}/Flat-UI/docs/assets/images/icons/calendar.svg" alt="Calendar"></div>
          <div><img src="{{ url('/') }}/Flat-UI/docs/assets/images/icons/paper-bag.svg" alt="Pocket"></div>
          <div><img src="{{ url('/') }}/Flat-UI/docs/assets/images/icons/clocks.svg" alt="Watches"></div>
          <div><img src="{{ url('/') }}/Flat-UI/docs/assets/images/icons/loop.svg" alt="Infinity-Loop"></div>
        </div>
      </div>
      ...
      <div class="row demo-tiles">
        ...
        <div class="col">
          <div class="tile">
            <img src="{{ url('/') }}/Flat-UI/docs/assets/images/icons/loop.svg" alt="Infinity-Loop" class="tile-image">
        ...
        <div class="col">
          <div class="tile">
            <img src="{{ url('/') }}/Flat-UI/docs/assets/images/icons/pencils.svg" alt="Pensils" class="tile-image">
        ...
        <div class="col">
          <div class="tile tile-hot">
            <img src="{{ url('/') }}/Flat-UI/docs/assets/images/icons/ribbon.svg" alt="ribbon" class="tile-hot-ribbon">
            <img src="{{ url('/') }}/Flat-UI/docs/assets/images/icons/chat.svg" alt="Chat" class="tile-image">
      ...
      <div class="row">
        <div class="col-9">
          <div class="demo-browser">
            ...
            <div class="demo-browser-content">
              <img src="{{ url('/') }}/Flat-UI/docs/assets/images/demo/browser-pic-1.jpg" alt="" />
              <img src="{{ url('/') }}/Flat-UI/docs/assets/images/demo/browser-pic-2.jpg" alt="" />
              <img src="{{ url('/') }}/Flat-UI/docs/assets/images/demo/browser-pic-3.jpg" alt="" />
              <img src="{{ url('/') }}/Flat-UI/docs/assets/images/demo/browser-pic-4.jpg" alt="" />
              <img src="{{ url('/') }}/Flat-UI/docs/assets/images/demo/browser-pic-5.jpg" alt="" />
              <img src="{{ url('/') }}/Flat-UI/docs/assets/images/demo/browser-pic-6.jpg" alt="" />
            </div>
          </div>
        </div>
        ...
        <div class="col-3">
          <div class="demo-download">
            <img src="{{ url('/') }}/Flat-UI/docs/assets/images/demo/html-icon.png" src="Free PSD" />
          </div>
        ...
        <div class="row">
          <div class="col-7">
            ...
            <p>Do you like this freebie? Want to get more stuff like this?<br/>
              ...
              Go to: <a href="https://designmodo.com/flat-free" target="_blank">designmodo.com/flat-free</a>
            </p>

            <p class="pvl">
              <a href="https://twitter.com/share" class="twitter-share-button" data-url="https://designmodo.com/flat-free/" data-text="Flat UI Free - PSD&amp;amp;HTML User Interface Kit" data-via="designmodo">Tweet</a>
            ...
            <a class="footer-brand" href="http://designmodo.com" target="_blank">
              <img src="{{ url('/') }}/Flat-UI/docs/assets/images/demo/logo.png" alt="Designmodo.com" />
            </a>
          </div> <!-- /col-7 -->
